<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="OnlineAppleStore.Checkout" %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="billing-details pr-10">
                                                        ...
                                                        <asp:TextBox ID="txtEmail" runat="server" placeholder="Email address here..."></asp:TextBox>
                                                        <%--<input type="text"  placeholder="Phone here...">--%>
                                                        <asp:TextBox ID="txtPhone" runat="server" placeholder="Phone here..."></asp:TextBox>
                                                        ...
                                                        <asp:TextBox ID="txtCity" runat="server" placeholder="City/Town..."></asp:TextBox>
                                                        ...
                                                        <asp:TextBox ID="txtAddress" runat="server" placeholder="Your address here..." TextMode="MultiLine"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <!-- our order -->
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <asp:DataList ID="DataList1" runat="server" style="width:100%">
                                                                    <ItemTemplate>
                                                                        <td class="td-title-1"><%# Eval("Name") %></td>
                                                                        <td class="td-title-2">₹<%# Eval("Price") %></td>
                                                                     </ItemTemplate>
                                                                </asp:DataList>
                                                            </tr>
                                                            <%--<tr>
                                                            ...
                                                            <tr>
                                                                <td class="td-title-1">Cart Subtotal</td>
                                                                <td class="td-title-2"><asp:Label ID="lblSubtotal" runat="server" Text="0"></asp:Label></td><br />
                                                            </tr>
                                                            <tr>
                                                                <td class="td-title-1">Shipping and Handing</td>
                                                                <td class="td-title-2"><asp:Label ID="lblShipping" runat="server" Text="0"></asp:Label></td><br />
                                                            </tr>
                                                            <tr>
                                                                <td class="order-total">Order Total</td>
                                                                <td class="order-total-price"><asp:Label ID="lblTotal" runat="server" Text="0"></asp:Label></td>
                                                            </tr>
                                                        </table>
                                                    </div> 
                                                    <!-- payment-method -->
                                                    ...
                                                    <%--<button class="submit-btn-1 mt-30 btn-hover-1" type="submit">place order</button>--%>
                                                            <asp:Button ID="btnPlaceOrder" runat="server" Text="place order" class="submit-btn-1 mt-30 btn-hover-1" OnClick="btnPlaceOrder_Click"/>
                                                </div>
                                            </div>
                                    </div>
                                </div>
