<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Shop.aspx.cs" Inherits="OnlineAppleStore.Shop" %>
                                            ...
                                            <div class="product-item">
                                                <div class="product-img">
                                                    <a href="single-product.html">
                                                        ...
                                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ProductDetails.aspx?Mobile_Id=" + Eval("Mobile_Id") %>'>
                                                ...
                                                <div class="product-info">
                                                    <h6 class="product-title">
                                                        <!--<a href="single-product.html">Product Name</a>-->
                                                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "ProductDetails.aspx?Mobile_Id=" + Eval("Mobile_Id") %>'>
                                                    ...
                                                    <ul class="action-button">
                                                        <%--<li>
                                                            <!--<a href="#" title="Wishlist"><i class="zmdi zmdi-favorite"></i></a>-->
                                                            <asp:HyperLink NavigateUrl='<%# "Wishlist.aspx?Mobile_Id=" + Eval("Mobile_Id") %>' ID="HyperLink3" runat="server" class="zmdi zmdi-favorite"></asp:HyperLink>
                                                        </li>
                                                        <li>
                                                            <!--<a href="#" title="Add to cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>-->
                                                            <asp:HyperLink NavigateUrl='<%# "Cart.aspx?Mobile_Id=" + Eval("Mobile_Id") %>' ID="HyperLink4" runat="server" class="zmdi zmdi-shopping-cart-plus"></asp:HyperLink>
                                                        </li>--%>
                                                    </ul>
                                                </div>
                                            </div>
