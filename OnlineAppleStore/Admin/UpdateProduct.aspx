<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="OnlineAppleStore.Admin.UpdateProduct" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrumbs-inner">
                                <h1 class="breadcrumbs-title">Update Product</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="new-customers">
                                    ...
                                    <h6 class="widget-title border-left mb-50">Update Product </h6>
                                    <div class="login-account p-30 box-shadow">
                                        ...
                                        <div>
                                            <div>
                                                <asp:Button ID="btnUpdateProduct" runat="server" Text="Update Product" class="submit-btn-1 mt-20 btn-hover-1" OnClick="btnUpdateProduct_Click"/>
                                            </div>
